...
import { CourseMock, PurchaseMock, UserMock, CourseProgressMock } from "@/lib/mock-data";
...
export default function AdminDashboardClient({
  ...
  const retentionCurve = [
    { lesson: "L 1.1 Introducción", retention: 100 },
    { lesson: "L 1.2 Bajos Reese FM", retention: 92 },
    { lesson: "L 2.1 Acordes Rítmicos", retention: 84 },
    { lesson: "L 2.2 Limpieza de Graves", retention: 76 },
    { lesson: "L 3.1 Canales SSL", retention: 68 },
    { lesson: "L 3.2 Saturación de Cinta", retention: 61 },
  ];
  ...
  const weeklyStreams = [
    ...
    { day: "Mié", streams: 890 },
    { day: "Jue", streams: 740 },
    { day: "Vie", streams: 1120 },
    { day: "Sáb", streams: 1450 },
    { day: "Dom", streams: 1290 },
  ];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-800/80 pb-6">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-500/10 border border-teal-500/30 text-teal-400 text-xs font-mono mb-2">
            ...
            <span>CONTROL ADMINISTRATIVO DE PLATAFORMA</span>
          </div>
          <h1 className="text-3xl font-extrabold text-zinc-100 tracking-tight">
            Panel de Métricas (KPI) y Métricas de Ingresos
          </h1>
          <p className="text-zinc-400 text-sm mt-1">
            Telemetría en tiempo real sobre la progresión de alumnos, abandono de cursos y ventas de la tienda musical.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono text-zinc-400 uppercase tracking-wider">Ingresos Brutos Totales</span>
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <span className="text-xs font-mono text-zinc-400 uppercase tracking-wider">Estudiantes Activos</span>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-bold text-base text-zinc-100 flex items-center gap-2">
                ...
                <span>Curva de Retención de Cursos (%)</span>
              </h3>
              <p className="text-xs text-zinc-400 mt-0.5">Tasa de retención lección por lección</p>
            </div>
            <span className="text-xs font-mono text-teal-400 bg-teal-500/10 px-2.5 py-1 rounded border border-teal-500/20">
              Masterclass de Serum
            </span>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-bold text-base text-zinc-100 flex items-center gap-2">
                ...
                <span>Reproducciones del Motor de Audio</span>
              </h3>
              <p className="text-xs text-zinc-400 mt-0.5">Actividad semanal de preescuchas de beats y samples</p>
            </div>
            <span className="text-xs font-mono text-purple-400 bg-purple-500/10 px-2.5 py-1 rounded border border-purple-500/20">
              7,590 Reproducciones Totales
            </span>
          </div>
      ...
      <div className="glass-card rounded-2xl p-6 space-y-4">
        <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
          <h3 className="font-bold text-base text-zinc-100 flex items-center gap-2">
            ...
            <span>Compras Recientes en la Plataforma</span>
          </h3>
            ...
            <div key={p.id} className="py-3 flex items-center justify-between text-xs">
              <div className="flex items-center gap-3">
                <span className="px-2 py-0.5 rounded font-mono uppercase bg-teal-500/10 text-teal-400 border border-teal-500/30">
                  {p.productType === "COURSE" ? "CURSO" : "RECURSO MUSICAL"}
                </span>
