...
import { INITIAL_COURSES, INITIAL_USERS, INITIAL_PROGRESS } from "@/lib/mock-data";
import { 
  Users, 
  AlertTriangle, 
  CheckCircle2, 
...
export default function StudentMatrixPage() {
  ...
  const [selectedCourseId, setSelectedCourseId] = useState<string>("crs-mezcla");
  ...
  const currentMetrics = courseEnrollments[selectedCourseId] || {
    enrolledCount: 20,
    avgCompletion: 50,
    stuckLesson: "Lección 1.1: Introducción Generales",
    stuckCount: 5,
  };
